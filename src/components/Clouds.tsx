export const CloudSmall = () => {
  return (
    <div className="fixed bottom-[80vh] md:bottom-[75vh] left-4 z-10 block opacity-80 animate-cloudMobile md:animate-cloud">
...
export const CloudMedium = () => {
  return (
    <div className="fixed bottom-[40vh] left-6 z-10 block opacity-80 animate-cloudMobile2 md:animate-cloud2">
      <div className="relative flex  justify-center">
...
export const Cloud = () => {
  return (
    <div className="fixed bottom-[20vh] md:bottom-[65vh] left-4 z-10 block opacity-80 animate-cloudMobile3 md:animate-cloud3">
      <div className="relative flex  justify-center">
