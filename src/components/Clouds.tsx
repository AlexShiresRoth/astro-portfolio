export const CloudSmall = () => {
  return (
    <div className="absolute bottom-[60vh] md:bottom-[75vh] left-4 z-10 block opacity-80 animate-cloudMobile md:animate-cloud">
...
export const Cloud = () => {
  return (
    <div className="absolute bottom-[40vh] md:bottom-[65vh] left-4 z-10 block opacity-80 animate-cloudMobile3 md:animate-cloud3">
      <div className="relative flex  justify-center">
