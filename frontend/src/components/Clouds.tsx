export const CloudSmall = () => {
  return (
    <div className="absolute top-0 l left-4 z-0 block opacity-80 animate-cloudMobile md:animate-cloud">
...
export const CloudMedium = () => {
  return (
    <div className="absolute bottom-full left-6 z-0 block opacity-80 animate-cloudMobile2 md:animate-cloud2">
      <div className="relative flex justify-center">
...
export const Cloud = () => {
  return (
    <div className="absolute bottom-full left-4 z-0 block opacity-80 animate-cloudMobile3 md:animate-cloud3">
      <div className="relative flex justify-center">
