...
const WorkComponent = async ({ workMap }: { workMap: Work[] }) => {
  return (
    <div className="flex flex-col p-24 bg-black border-t-8 border-b-8 border-gray-500 w-full">
      <div className="flex flex-col gap-20">
        {workMap.map((work) => {
          return (
            <div key={work._id} className="grid grid-cols-2 gap-8 items-center">
              <div>
